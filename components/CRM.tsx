...
const CRM: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col space-y-6 animate-fadeIn relative pb-6">
      ...
      {selectedLead && (
        // AJUSTE REALIZADO AQUI: z-[60] para garantir que fique em cima do header
        <div className="fixed inset-0 z-[60] flex justify-end">
           ...
           {/* AJUSTE REALIZADO AQUI: pt-24 adicionado para empurrar o conteúdo para baixo do header */}
